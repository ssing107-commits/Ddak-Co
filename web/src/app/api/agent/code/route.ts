...
- tsconfig.json의 compilerOptions는 Next.js 14 + create-next-app 수준만 사용할 것. paths에 "@/*": ["./*"] 를 반드시 포함할 것(@/ import 해석·webpack module-not-found 방지). useDefineForEnumMembers, verbatimModuleSyntax 등 Next 번들 TS가 모르는 옵션은 넣지 말 것(넣으면 Unknown compiler option으로 빌드 실패).
